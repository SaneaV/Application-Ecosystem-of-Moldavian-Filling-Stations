...
export const anrePricesTitle = {
    ru: "Средние цены ANRE",
    en: "ANRE Average Prices",
    ro: "Prețuri Medii ANRE",
    ua: "Середні ціни ANRE"
};

export const uiLabels = {
    filterTitle: { ru: "Настройки фильтра", en: "Filter settings", ro: "Setări filtru", ua: "Налаштування фільтра" },
    cityFilterTitle: { ru: "Город", en: "City", ro: "Oraș", ua: "Місто" },
    brandFilterTitle: { ru: "АЗС", en: "Station", ro: "Stație", ua: "АЗС" },
    fuelFilterTitle: { ru: "Тип топлива", en: "Fuel type", ro: "Tip combustibil", ua: "Тип палива" },
    districtFilterTitle: { ru: "Регион", en: "District", ro: "Raion", ua: "Регіон" },
    connectorFilterTitle: { ru: "Тип коннектора", en: "Connector type", ro: "Tip conector", ua: "Тип конектора" },
    allCities: { ru: "Все города", en: "All cities", ro: "Toate orașele", ua: "Всі міста" },
    allBrands: { ru: "Все бренды", en: "All brands", ro: "Toate brandurile", ua: "Всі бренди" },
    allFuelTypes: { ru: "Все типы", en: "All types", ro: "Toate tipurile", ua: "Всі типи" },
    allDistricts: { ru: "Все районы", en: "All districts", ro: "Toate raioanele", ua: "Всі райони" },
    allConnectorTypes: { ru: "Все типы", en: "All types", ro: "Toate tipurile", ua: "Всі типи" },
    apply: { ru: "Применить", en: "Apply", ro: "Aplică", ua: "Застосувати" },
    clear: { ru: "Очистить", en: "Clear", ro: "Șterge", ua: "Очистити" },
    filterButton: { ru: "Фильтрация", en: "Filter", ro: "Filtru", ua: "Фільтрація" },
    buildRoute: { ru: "Маршрут", en: "Route", ro: "Rută", ua: "Маршрут" },
    petrol: { ru: "Бензин", en: "Petrol", ro: "Benzină", ua: "Бензин" },
    diesel: { ru: "Дизель", en: "Diesel", ro: "Motorină", ua: "Дизель" },
    gas: { ru: "Газ", en: "Gas", ro: "Gaz", ua: "Газ" }
};
