...
public class FuelStationController {
  ...
  public ResponseEntity<PageDto<FuelStationDto>> getPageOfAllFuelStations(FuelStationRequest request, WebRequest webRequest) {
    setExceptionHandlerClient(webRequest);
    final PageDto<FuelStationDto> fuelStationDtoPageDto = fuelStationPageWrapper.wrapAllFuelStationList(request.getLatitude(),
        request.getLongitude(), request.getRadius(), request.getLimitInRadius(), request.getLimit(), request.getOffset());
  ...
  public ResponseEntity<List<FuelStationDto>> getBestFuelPrice(FuelStationRequest request,
      @PathVariable(value = "fuel-type") String fuelType, WebRequest webRequest) {
    setExceptionHandlerClient(webRequest);
