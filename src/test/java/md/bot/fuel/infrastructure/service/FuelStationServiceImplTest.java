...
public class FuelStationServiceImplTest {
    ...
    void shouldReturnBestFuelPriceStation(String fuelType) {
        ...
        final List<FuelStation> bestFuelPrice = fuelStationService.getBestFuelPrice(46.970797, 28.727367, 100000, fuelType,
                LIMIT);
    ...
    private List<FuelStation> getFuelStations() {
        ...
        return asList(fuelStation, fuelStation1, fuelStation2, fuelStation3, fuelStation4, fuelStation5, fuelStation6,
                fuelStation7, fuelStation8, fuelStation9, fuelStation10, fuelStation11);
    }
}
