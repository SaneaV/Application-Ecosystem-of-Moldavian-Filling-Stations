...
public class AnreApiMapperTest {
  ...
  void shouldMapFuelStationApiToFuelStation() {
    final FuelStationApi fuelStationApi = new FuelStationApi(FUEL_STATION_NAME, PETROL_PRICE, DIESEL_PRICE, GAS_PRICE, LATITUDE,
        LONGITUDE);
  ...
  void shouldMapZeroOrNullPriceToNull() {
    final FuelStationApi fuelStationApi = new FuelStationApi(FUEL_STATION_NAME, 0.0, null, 0.0D, LATITUDE, LONGITUDE);
