...
public class FuelStationFacadeImplTest {
    ...
    void shouldReturnListOfAllFuelStation() {
        ...
        final List<FuelStationDto> allFuelStations = fuelStationFacade.getAllFuelStations(LATITUDE, LONGITUDE, RADIUS,
                VALID_LIMIT);
    ...
    void shouldReturnListOfBestFuelPriceFuelStations() {
        ...
        final List<FuelStationDto> bestFuelPriceStation = fuelStationFacade.getBestFuelPrice(LATITUDE, LONGITUDE, RADIUS,
                FUEL_TYPE, VALID_LIMIT);
